...
export default function Advertisement () {
    ...
    return (
        <>
            ...
            <Local setCompany={setCompany} setDescription={setDescription} width={width} setWidth={setWidth} height={height} setHeight={setHeight} left={left} setLeft={setLeft} top={top} setTop={setTop} mediaPreview={mediaPreview} setMediaPreview={setMediaPreview} />
            <FocusLock>
