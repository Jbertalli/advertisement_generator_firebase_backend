...
export default function Local(values) {
  ...
  //     localStorage.getItem(LOCAL_STORAGE_KEY_NAME_MOBILE)
  //   );
  ...
  //     localStorage.getItem(LOCAL_STORAGE_KEY_DESCRIPTION_MOBILE)
  //   );
  ...
  // useEffect(() => {
  //   localStorage.setItem(
  //     LOCAL_STORAGE_KEY_DESCRIPTION_MOBILE,
  ...
  //     localStorage.getItem(LOCAL_STORAGE_KEY_WIDTH_MOBILE)
  //   );
  ...
  // useEffect(() => {
  //   localStorage.setItem(
  //     LOCAL_STORAGE_KEY_WIDTH_MOBILE,
  ...
  //     localStorage.getItem(LOCAL_STORAGE_KEY_HEIGHT_MOBILE)
  //   );
  ...
  // useEffect(() => {
  //   localStorage.setItem(
  //     LOCAL_STORAGE_KEY_HEIGHT_MOBILE,
  ...
  // // left
  // useEffect(() => {
  //   const storedLeft = JSON.parse(
  //     localStorage.getItem(LOCAL_STORAGE_KEY_LEFT_MOBILE)
  //   );
  ...
  // // top
  // useEffect(() => {
  //   const storedTop = JSON.parse(
  //     localStorage.getItem(LOCAL_STORAGE_KEY_TOP_MOBILE)
  //   );
  //   if (storedTop) setTop(storedTop);
  // }, []);

  // useEffect(() => {
  //   localStorage.setItem(LOCAL_STORAGE_KEY_TOP_MOBILE, JSON.stringify(topName));
  // }, [topName]);

  // // Image
  // useEffect(() => {
  //   const storedImage = JSON.parse(
  //     localStorage.getItem(LOCAL_STORAGE_KEY_IMAGE_MOBILE)
  //   );
  ...
  // useEffect(() => {
  //   localStorage.setItem(
  //     LOCAL_STORAGE_KEY_IMAGE_MOBILE,
  ...
  useEffect(() => {
    localStorage.setItem(LOCAL_STORAGE_KEY_TOP_MOBILE, JSON.stringify(top));
  }, [top]);
